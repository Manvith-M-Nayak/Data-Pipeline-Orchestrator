...
def main():
    ...
    subscription_id = "cac332f5-5bb7-4ae9-82f6-6bad0ac8eab8"
    resource_group = "adf-demo-rg"
    factory_name = "adf-monitor-demo"

    credential = DefaultAzureCredential()
    adf_client = DataFactoryManagementClient(credential, subscription_id)
    monitoring_agent = MonitoringAgent(adf_client, resource_group, factory_name)
    ...
    # -- Step 10: Trigger pipelines in execution order
    print("\n--- Step 10: Triggering Pipelines ---")
    all_succeeded = True
    ...
    # -- Step 11: Run Monitoring Agent AFTER pipelines have been triggered
    print("\n--- Step 11: Running Monitoring Agent ---")

...
# ============================================================
# AUTH: Get Azure Access Token via Azure CLI (free tier)
# No client secret needed — uses `az login` credentials.
# ============================================================
def get_access_token() -> str:
    credential = DefaultAzureCredential()
    token = credential.get_token("https://management.azure.com/.default")
    print("Azure access token obtained via DefaultAzureCredential")
    return token.token
